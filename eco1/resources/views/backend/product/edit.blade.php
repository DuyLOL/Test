...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Tựa đề <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Chú thích</label>
        ...
        <div class="form-group">
          <label for="is_featured">Hiện </label><br>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="L"  @if( in_array( "L",$data ) ) selected @endif>To</option>
              <option value="XL"  @if( in_array( "XL",$data ) ) selected @endif>Rất to</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="condition">Kiểu hàng</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($product->status=='active')? 'selected' : '')}}>Có</option>
            <option value="inactive" {{(($product->status=='inactive')? 'selected' : '')}}>Không</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
