...
@section('title','DUY-SHOP || Chi Tiết bài viết')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Bình Luận</span><span class="comment_btn reply" style="display: none;">Phản Hồi</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Danh Mục Tin</h3>
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">DuyShop</h3>
                            <div class="letter-inner">
                                <h4>Đăng ký để theo dõi <br> tin tức mới nhất.</h4>
