<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chọn:</h6>
            <a class="collapse-item" href="{{route('category.index')}}">Xem</a>
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chọn:</h6>
            <a class="collapse-item" href="{{route('brand.index')}}">Hãng</a>
            <a class="collapse-item" href="{{route('brand.create')}}">Thêm</a>
          </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('shipping.create')}}">Thêm</a>
          </div>
        </div>
    </li>
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('post-category.create')}}">Thêm </a>
          </div>
        </div>
      </li>
    ...
    <li class="nav-item">
        ...
        <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chọn:</h6>
            <a class="collapse-item" href="{{route('post-tag.index')}}">Xem Tag</a>
