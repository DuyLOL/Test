...
@endsection
@section('title','DUY-SHOP || Chi Tiết Sản Phẩm')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												@endif
												<p class="availability">Hàng Tồn : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Chi Tiết SP</a></li>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		<h5>Thêm nhận xét</h5>
																		<p>Địa chỉ Email của bạn sẽ không hiện công khai</p>
																	</div>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Số đông)</span></h4>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            <span class="price-dec">Giảm giá{{$data->discount}} </span>
                                                                    {{-- <span class="out-of-stock">Hot</span> --}}
                                        </a>
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Mua nhanh</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Thêm vào mục ưa thích</span></a>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <div class="quickview-peragraph">
                                <p>Đây là sản phẩm được nhiều người ưa chuộng.</p>
                            </div>
                            <div class="size">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
