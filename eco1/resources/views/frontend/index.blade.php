...
@section('title','DUY-SHOP || Trang Chủ')
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a href="{{route('add-to-cart',$product->slug)}}">Thêm vô giỏ</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> ({{$rate_count}} khách review)</a>
                                            </div>
                                            <div class="quickview-stock">
                                                @if($product->stock >0)
                                                <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} còn hàng</span>
                                                @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} hết</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
                                        ...
                                        <form action="{{route('single-add-to-cart')}}" method="POST" class="mt-4">
                                            ...
                                            <div class="add-to-cart">
                                                <button type="submit" class="btn">Thêm vô giỏ</button>
