...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.store')}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Nhập tựa đề"  value="{{old('title')}}" class="form-control">
        @error('title')
        ...
        <div class="form-group">
          <label for="inputDesc" class="col-form-label">Chi tiết</label>
