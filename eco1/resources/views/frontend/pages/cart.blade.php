								...
								@else
										<tr>
											<td class="text-center">
												Hiện tại chưa có SP trong giỏ. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp Tục Mua</a>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tổng Cộng<span>{{number_format(Helper::totalCartPrice(),2)}}</span></li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Tiếp Kiệm<span>{{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Tiền Trả<span>{{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Tiền Trả<span>{{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
									<div class="button5">
										...
										<a href="{{route('product-grids')}}" class="btn">Tiếp Tục Mua</a>
									</div>
								</div>
							</div>
						</div>
