...
@section('title','DUY-SHOP || Trang Sản Phẩm')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Danh Sách SP</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget category">
                                    <h3 class="title">Danh Mục<col></h3>
								...
								<div class="single-widget range">
									...
									<div class="price-filter">
										<div class="price-filter-inner">
											...
											<button type="submit" class="filter_button">Lựa chọn</button>
											<div class="label-input">
												<span>Mức:</span>
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Bài viết mới đây</h3>
                                    {{-- {{dd($recent_products)}} --}}
						...
						<div class="col-lg-9 col-md-8 col-12">
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="brand" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='brand') selected @endif>Hãng</option>
												</select>
											</div>
										</div>
										<ul class="view-mode">
							...
							<div class="row">
								@if(count($products))
									...
									@endforeach
								@else
									<h4 class="text-warning" style="margin:100px auto;">Chưa có sản phẩm.</h4>
								@endif
							</div>
							 <div class="row">
											...
											<div class="quickview-content">
												...
												<div class="quickview-ratting-review">
													<div class="quickview-ratting-wrap">
														...
														<a href="#"> ({{$rate_count}} Khách đánh giá)</a>
													</div>
