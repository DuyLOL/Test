...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Chú thích ngắn <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Chú thích dài</label>
        ...
        <div class="form-group">
          <label for="discount" class="col-form-label">Giảm(%)</label>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="L">Rộng (L)</option>
              <option value="XL">Rất Rộng (XL)</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
              ...
              <option value="inactive">Ko</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
