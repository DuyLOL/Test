            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Theo Giõi Đơn</a></li>
                    ...
                    <div class="right-bar">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{count(Helper::getAllProductFromWishlist())}} Hàng</span>
                                        <a href="{{route('wishlist')}}">Xem Mục Yêu Thích</a>
                                    </div>
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{count(Helper::getAllProductFromCart())}} Hàng</span>
                                        <a href="{{route('cart')}}">Xem Giỏ</a>
                                    </div>
                                    <ul class="shopping-list">
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
