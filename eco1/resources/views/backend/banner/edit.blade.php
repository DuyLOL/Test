...
@section('title','DUY-SHOP || Sửa Banner')
...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Nhập"  value="{{$banner->title}}" class="form-control">
        @error('title')
        ...
        <div class="form-group">
          <label for="inputDesc" class="col-form-label">Phụ đề</label>
