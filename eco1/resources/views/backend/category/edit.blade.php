...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Từ khoá</label>
        ...
        <div class="form-group">
          <label for="is_parent">Danh mục con</label><br>
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
              <option value="active" {{(($category->status=='active')? 'selected' : '')}}>Có</option>
              <option value="inactive" {{(($category->status=='inactive')? 'selected' : '')}}>Ko</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
