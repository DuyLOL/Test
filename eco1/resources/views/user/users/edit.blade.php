    ...
    <div class="card-body">
      <form method="post" action="{{route('users.update',$user->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputEmail" type="email" name="email" placeholder=" email"  value="{{$user->email}}" class="form-control">
          @error('email')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="status" class="form-control">
                <option value="active" {{(($user->status=='active') ? 'selected' : '')}}>Trực Tuyến</option>
                <option value="inactive" {{(($user->status=='inactive') ? 'selected' : '')}}>Vô tuyến</option>
            </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
