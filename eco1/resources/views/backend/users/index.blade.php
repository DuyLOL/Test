...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm</a>
    </div>
    <div class="card-body">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="#delModal{{$user->id}}Label">Xoá</h5>
                            ...
                            <div class="modal-body">
                              <form method="post" action="{{ route('users.destroy',$user->id) }}">
                                @csrf 
                                @method('delete')
                                <button type="submit" class="btn btn-danger" style="margin:auto; text-align:center">Xoá Vĩnh Viễn</button>
                              </form>
                            </div>
                          </div>
                        </div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                  title: "Bạn chắc chứ?",
                  text: "Khi đã xoá thì sẽ không thể phục hồi!",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
                })
