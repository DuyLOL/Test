...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">Tiêu đề</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($post->status=='active')? 'selected' : '')}}>Có</option>
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>Ko</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
