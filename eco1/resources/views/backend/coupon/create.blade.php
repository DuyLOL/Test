...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.store')}}">
        ...
        <input id="inputTitle" type="text" name="code" placeholder="Nhập"  value="{{old('code')}}" class="form-control">
        @error('code')
        ...
        <div class="form-group">
            ...
            <input id="inputTitle" type="number" name="value" placeholder="Nhập"  value="{{old('value')}}" class="form-control">
            @error('value')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
